...
import Memberr from '../assests/memberr.png'
  ...
  return (
    <div className='w-full py-[10rem] px-4 bg-white'>
        <div className='max-w-[1240px] mx-auto grid md:grid-cols-3 gap-8'>
            ...
            <img className='w-20 mx-auto mt-[-3rem] bg bg-white' src={Single} alt="/" />
            ...
            <div className='w-full shadow-xl flex flex-col p-4 my-4 rounded-lg hover:scale-105 duration-300'>
            <img className='w-20 mx-auto mt-[-3rem] bg bg-white' src={Double} alt="/" />
            ...
            <div className='w-full shadow-xl flex flex-col p-4 my-4 rounded-lg hover:scale-105 duration-300'>
            <img className='w-20 mx-auto mt-[-3rem] bg bg-white' src={Triple} alt="/" />
            ...
            <div className='w-full shadow-xl flex flex-col p-4 my-4 rounded-lg hover:scale-105 duration-300'>
            <img className='w-20 mx-auto mt-[-3rem]' src={Memberr} alt="/" />
            <h2 className='text-2xl font-bold text-center py-8'>Member Only</h2>
            <p className='text-center text-4xl font-bold'>$750</p>
            <div className='text-center font-medium'>
              <p className='py-2 border-b mx-8 mt-8'>5 TB Storage</p>
              <p className='py-2 border-b mx-8'>Member Granted User</p>
              <p className='py-2 border-b mx-8'>Send up to 5 TB</p>
            </div>
            <button className='bg-black text-[#00df9a] w-[200px] rounded-md font-medium my-6 mx-auto py-3'>Start</button>
            </div>
        </div>
    </div>
  )
